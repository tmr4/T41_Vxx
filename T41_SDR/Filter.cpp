...
FLASHMEM void SetDecIntFIRFilters(int decFilterBW = 0) {
  ...
  if(decFilterBW > 0) {
    CalcZoomFIRCoeffs(FIR_dec1_coeffs, 27, decFilterBW, 90.0, t41.SampleRate);
    CalcZoomFIRCoeffs(FIR_dec2_coeffs, 33, decFilterBW, 90.0, t41.SampleRate / 4.0);
    CalcZoomFIRCoeffs(FIR_dec3_coeffs, 50, decFilterBW, 90.0, t41.SampleRate / 4.0);
  } else {
    CalcZoomFIRCoeffs(FIR_dec1_coeffs, 27, limit, 90.0, t41.SampleRate);
    CalcZoomFIRCoeffs(FIR_dec2_coeffs, 33, limit, 90.0, t41.SampleRate / 4.0);
    CalcZoomFIRCoeffs(FIR_dec3_coeffs, 50, limit, 90.0, t41.SampleRate / 4.0);
  }

  CalcZoomFIRCoeffs(FIR_int1_coeffs, 48, limit, 90.0, t41.SampleRate / 4.0);
  CalcZoomFIRCoeffs(FIR_int2_coeffs, 32, limit, 90.0, t41.SampleRate);
}
