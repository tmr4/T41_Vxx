...
#define RADIO_ROLE 14           // 0:standard ops, 1:WSJT-X, *** See Remote operation below for additional settings ***
...
#if (RADIO_ROLE < 0) || (RADIO_ROLE > 15)
  #undef RADIO_ROLE
  #define RADIO_ROLE 0
#else
  #if RADIO_ROLE == 1 || RADIO_ROLE == 14 || RADIO_ROLE == 15
