...
#define CAT_CONTROL_HOST  false  // cable from USB host on this unit (T41) to serial on remote
#define CAT_CONTROL       true   // cable from serial on this unit (remote) to USB host on T41
...
#define SEND_IQ_TO_HOST   false  // cable from USB host on this unit (T41) to serial on remote
#define REC_IQ_FROM_HOST  true   // cable from serial on this unit (remote) to USB host on T41
